...
function Projects() {
	return (
		<div id="projects" className=" dark:bg-slate-900 py-20 sm:max-sm:h-[80vh]">
			...
			<div className="flex gap-10 px-24 bigScreen:px-80 flex-wrap w-full mobile:max-sm:items-center mobile:max-sm:flex-col mobile:max-sm:px-0 justify-between items-center  py-20">
				{projectData.map((project, i) => (
					<Link
						...
						target="_blank"
						key={i}
						className="w-[30%] mobile:max-sm:w-[90vw] mobile:max-sm:h-auto dark:bg-slate-800   rounded-md mt-5 hover:cursor-pointer bg-white h-[350px] shadow-md hover:scale-105 duration-300"
					>
						<div
							style={{
